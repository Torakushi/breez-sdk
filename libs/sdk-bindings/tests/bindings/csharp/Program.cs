...
try
{
 ...
 BlockingBreezServices sdkServices = BreezSdkMethods.Connect(config, seed, new SDKListener(), new SDKNodeLogger("1"), null);
 BlockingBreezServices sdkServices2 = BreezSdkMethods.Connect(config, seed2, new SDKListener(), new SDKNodeLogger("2"), null);
